...
namespace HNGxVideoStreaming.Services
{
    public class UploadService : IUploadService
    {
        ...
        private readonly VideoSteamApiDbContext _dbContext;
        ...
        public UploadService(
            ...
            ILogger<UploadService> logger, VideoSteamApiDbContext dbContext)
        {
        ...
        public async Task<Response> StartUpload(string fileName)
        {
            try
            {
                ...
                string generatedKey = GenerateRandomKey(allowedCharacters, keyLength) + ".mp4";
                ...
                { 
                    ...
                    Updatedby = nameof(UploadService)
                }); ;
        ...
        public async Task<Response> UploadChunks(string uploadKey)
        {
            ...
            try
            {
                ...
                uploadContext.UpdatedDate = DateTime.UtcNow;
        ...
        public async Task<Response> UploadComplete(string uploadKey)
        {
            try
            {
                #region check if upload key exists
        ...
        public async Task<Response> StreamVideo(string uploadKey)
        {
            try
            {
        ...
        public async Task<Response> DeleteVideo(string uploadKey)
        {
            try
            {
                #region Check if upload key exists
